...
# tokenizer = BertTokenizer.from_pretrained(r"C:\Users\sixinheyi\.cache\huggingface\transformers\bert-base-uncased-local")
# model = BertModel.from_pretrained(r"C:\Users\sixinheyi\.cache\huggingface\transformers\bert-base-uncased-local")
...
path2 = r"/public/home/sixinheyi/MSA/dataset/SIMS/Processed/bert-base-chinese"
...
class BertTextEncoder(nn.Module):
    def __init__(self, use_finetune=False, transformers='bert', pretrained='bert-base-chinese'):
        super().__init__()
